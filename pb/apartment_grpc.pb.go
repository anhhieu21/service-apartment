...
const (
	ApartmentService_GetApartment_FullMethodName    = "/proto.ApartmentService/GetApartment"
	ApartmentService_CreateApartment_FullMethodName = "/proto.ApartmentService/CreateApartment"
	ApartmentService_UpdateApartment_FullMethodName = "/proto.ApartmentService/UpdateApartment"
	ApartmentService_DeleteApartment_FullMethodName = "/proto.ApartmentService/DeleteApartment"
)
...
func (c *apartmentServiceClient) GetApartment(ctx context.Context, in *GetApartmentRequest, opts ...grpc.CallOption) (*GetApartmentResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApartmentService_GetApartment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apartmentServiceClient) CreateApartment(ctx context.Context, in *CreateApartmentRequest, opts ...grpc.CallOption) (*CreateApartmentResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApartmentService_CreateApartment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apartmentServiceClient) UpdateApartment(ctx context.Context, in *UpdateApartmentRequest, opts ...grpc.CallOption) (*UpdateApartmentResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApartmentService_UpdateApartment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apartmentServiceClient) DeleteApartment(ctx context.Context, in *DeleteApartmentRequest, opts ...grpc.CallOption) (*DeleteApartmentResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApartmentService_DeleteApartment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
const (
	CustomerService_Login_FullMethodName          = "/proto.CustomerService/Login"
	CustomerService_GetCustomer_FullMethodName    = "/proto.CustomerService/GetCustomer"
	CustomerService_FindMe_FullMethodName         = "/proto.CustomerService/FindMe"
	CustomerService_Register_FullMethodName       = "/proto.CustomerService/Register"
	CustomerService_UpdateCustomer_FullMethodName = "/proto.CustomerService/UpdateCustomer"
	CustomerService_DeleteCustomer_FullMethodName = "/proto.CustomerService/DeleteCustomer"
	CustomerService_GetApartment_FullMethodName   = "/proto.CustomerService/GetApartment"
	CustomerService_GetApartments_FullMethodName  = "/proto.CustomerService/GetApartments"
)
...
type CustomerServiceClient interface {
	...
	GetApartment(ctx context.Context, in *GetApartmentRequest, opts ...grpc.CallOption) (*GetApartmentResponse, error)
	GetApartments(ctx context.Context, in *GetApartmentsRequest, opts ...grpc.CallOption) (*GetApartmentsResponse, error)
}
...
func (c *customerServiceClient) FindMe(ctx context.Context, in *FindMeRequest, opts ...grpc.CallOption) (*FindMeResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomerService_FindMe_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customerServiceClient) GetApartment(ctx context.Context, in *GetApartmentRequest, opts ...grpc.CallOption) (*GetApartmentResponse, error) {
	out := new(GetApartmentResponse)
	err := c.cc.Invoke(ctx, CustomerService_GetApartment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customerServiceClient) GetApartments(ctx context.Context, in *GetApartmentsRequest, opts ...grpc.CallOption) (*GetApartmentsResponse, error) {
	out := new(GetApartmentsResponse)
	err := c.cc.Invoke(ctx, CustomerService_GetApartments_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomerServiceServer interface {
	...
	GetApartment(context.Context, *GetApartmentRequest) (*GetApartmentResponse, error)
	GetApartments(context.Context, *GetApartmentsRequest) (*GetApartmentsResponse, error)
...
func (UnimplementedCustomerServiceServer) GetApartment(context.Context, *GetApartmentRequest) (*GetApartmentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetApartment not implemented")
}
func (UnimplementedCustomerServiceServer) GetApartments(context.Context, *GetApartmentsRequest) (*GetApartmentsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetApartments not implemented")
}
...
func _CustomerService_FindMe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomerService_FindMe_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CustomerService_GetApartment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetApartmentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CustomerServiceServer).GetApartment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomerService_GetApartment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).GetApartment(ctx, req.(*GetApartmentRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CustomerService_GetApartments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetApartmentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CustomerServiceServer).GetApartments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomerService_GetApartments_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).GetApartments(ctx, req.(*GetApartmentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CustomerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetApartment",
			Handler:    _CustomerService_GetApartment_Handler,
		},
		{
			MethodName: "GetApartments",
			Handler:    _CustomerService_GetApartments_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/proto/apartment.proto",
